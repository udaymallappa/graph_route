...
import lib1
from lib1.utils import global_variables, require_variables, iterate_minibatches
from lib1.nn_utils import get_device_of
...
def prepare_vectors(agent, graph, queries, batch_size=None, **kwargs):
    ...
    with torch.no_grad():
        ...
        vertex_id_to_vectors = walker_agent.PrecomputedWalkerAgent(agent).prepare_state(
